...
class ServidorWebSimple {
    public static void main(String argv[]) throws Exception {
        ...
        // el método accept() de socketdeEscucha craerá un nuevo objeto:
        // socketdeConexion
        Socket socketdeConexion = socketdeEscucha.accept();

        // ahora se crean dos "streams": mensajeDesdeCliente y mensajeParaCliente
        BufferedReader mensajeDesdeCliente = new BufferedReader(new InputStreamReader(
                socketdeConexion.getInputStream()));
        DataOutputStream mensajeParaCliente = new DataOutputStream(
        ...
        if (lineaSeparada.nextToken().equals("GET")) {
            ...
            // La siguiente línea asocia un "stream", archivoDeEntrada, al archivo
            // nombreArchivo
            ...
            // para el browser, colocando la línea de respuesta en el "stream"
            // mensajeParaCliente
